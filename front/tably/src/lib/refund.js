...
//
// 백엔드 RefundCalculator와 같은 규칙을 프론트에서 재현한다.
// 실제 예약의 사전 고지는 서버 refund-preview API(2026-07-31 추가)를 쓰고,
// 이 유틸은 백엔드에 없는 목 예약의 고지와 정책 안내 문구(describeRefundRule)에만 남는다.
